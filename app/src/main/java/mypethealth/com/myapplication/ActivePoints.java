...
public class ActivePoints extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_active_points);
        ...
        String temprature_url = "https://api.thingspeak.com/channels/120726/fields/7.json?results=100";
        ...
        try {
            if (temperature_json != null) {
                ...
                for (int i = 0; i < values.length(); i++) {
                    ...
                    temperature_sensor = obj.getString("field7");
                ...
                ListView l1 = (ListView) findViewById(R.id.active_points_list);
